...
class TextProcessing:
    ...
    def run(self, file_name: str, version: int):
        ...
        PATH_DATA_RAW = "C:/Users/jaayg/OneDrive/Escritorio/proyectos/Mlops-platzi/orchestration/data/data_raw"
        PATH_DATA_PROCESSED = "C:/Users/jaayg/OneDrive/Escritorio/proyectos/Mlops-platzi/orchestration/data/data_processed"
        # reading JSON data
